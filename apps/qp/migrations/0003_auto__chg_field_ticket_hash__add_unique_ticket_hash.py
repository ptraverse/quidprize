...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ticket.hash'
        db.alter_column('qp_ticket', 'hash', self.gf('django.db.models.fields.CharField')(unique=True, max_length=16))
        # Adding unique constraint on 'Ticket', fields ['hash']
        db.create_unique('qp_ticket', ['hash'])


    def backwards(self, orm):
        # Removing unique constraint on 'Ticket', fields ['hash']
        db.delete_unique('qp_ticket', ['hash'])


        # Changing field 'Ticket.hash'
        db.alter_column('qp_ticket', 'hash', self.gf('django.db.models.fields.CharField')(max_length='16'))
