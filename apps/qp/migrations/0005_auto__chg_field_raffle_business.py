...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Raffle.business'
        db.alter_column('qp_raffle', 'business_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qp.Business'], null=True))

    def backwards(self, orm):

        # Changing field 'Raffle.business'
        db.alter_column('qp_raffle', 'business_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['qp.Business']))
