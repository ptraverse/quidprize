...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('qp_completion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qp.Ticket'])),
            ('date_inserted', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('http_referer', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
            ('remote_addr', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
            ('remote_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
        ))
        db.send_create_signal('qp', ['Completion'])


    def backwards(self, orm):
        # Deleting model 'Completion'
        db.delete_table('qp_completion')
